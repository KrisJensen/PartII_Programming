...
def plats():
   ...
   try: assert typ in ['tet','oct','cube','dod','icos','b']
...
while new == 'y':   #outer loop in which calculations are run.
   ...
   print("\n\nType 'l' to look at linear polyenes, type 'c' to look at circular polyenes, 'p' to look at Platonic solids and Buckminsterfullerene\n")
